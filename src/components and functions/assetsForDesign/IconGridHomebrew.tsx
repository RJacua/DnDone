...
// import HBImg from '../../assets/hb.png'; // ✅ caminho relativo (se você for usar depois)
import forgImg from '../../assets/forg.png'; // ✅ corrigido
            ...
            <div className="row justify-content-center">
              <div className="col-lg-4 col-md-4 col-sm-6 mb-4">
                <div className="p-3 text-center grid-item">
                  <Link
                    to="/homebrew_creation/magic_item"
              ...
              <div className="col-lg-4 col-md-4 col-sm-6 mb-4">
                <div className="p-3 text-center grid-item">
                  <Link
                    to="/homebrew_creation/equipment"
                    className="grid-item custom-link"
                  >
