...
export default function CampaignListSearch({ isYours }) {
    ...
    const fetchItemsFromApi = async () => {
        ...
        try {
            ...
            console.log(data)
             if (isYours && !(user[0].role === "master")) { //no lobby no master
    ...
    return (
        <div className="container">
            <div className="row">
                ...
                isYours={isYours} 
                isPlayer={user && !(user.role === "master")}/>
                <br />
                    <div className="row">
                        {user && user[0].role === "master" && isYours && <div className="col-md-3 my-3" >
